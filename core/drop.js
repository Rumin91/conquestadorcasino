...
function logDrop(mult){var chip=document.createElement("span");chip.className="drop-chip-2bbf56a5"+
...
function say(text,mood){noteEl.textContent=text;noteEl.classList.remove("drop-note-up","drop-note-down");if(mood==="up"){noteEl.classList.add("drop-note-up-2bbf56a5");}else if(mood==="down"){noteEl.classList.add("drop-note-down-2bbf56a5");}}
